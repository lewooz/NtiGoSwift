//
//  DigitalCollectionController.swift
//  NtiGo
//
...
class DigitalCollectionController: UICollectionViewController, UINavigationBarDelegate {
    
    
    @IBOutlet weak var navigationBar: UINavigationItem!
    
   
    @IBOutlet var digitalCollectionView: UICollectionView!
    ...
    override func viewDidLoad() {
        ...
        digitalCollectionView.delegate = self
        digitalCollectionView.dataSource = self
        ...
        digitalCollectionView.backgroundView = imageView
        ...
        digitalCollectionView.translatesAutoresizingMaskIntoConstraints = false
        digitalCollectionView.topAnchor.constraint(equalTo: bar.bottomAnchor, constant: 0).isActive = true
        digitalCollectionView.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 0).isActive = true
        digitalCollectionView.rightAnchor.constraint(equalTo: view.rightAnchor, constant: 0).isActive = true
        digitalCollectionView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 0).isActive = true
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "digitalCell", for: indexPath) as! InteriorCell
    ...
    func createNavItem() -> UINavigationItem{
        ...
        item.title = "DIGITAL INPUT CENSORS"
    ...
    func createNavBar(item : UINavigationItem){
        ...
        appearance.backgroundImage = UIImage(named: "digitalbackground")
