//
//  InteriorCollectionController.swift
//  NtiGo
//
...
class InteriorCollectionController: UICollectionViewController , UINavigationBarDelegate{
    
    
    @IBOutlet weak var navigationBar: UINavigationItem!
    
    @IBOutlet var interiorCollectionView: UICollectionView!
    ...
    override func viewDidLoad() {
        ...
        interiorCollectionView.backgroundView = imageView
        ...
        interiorCollectionView.translatesAutoresizingMaskIntoConstraints = false
        interiorCollectionView.topAnchor.constraint(equalTo: bar.bottomAnchor, constant: 0).isActive = true
        interiorCollectionView.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 0).isActive = true
        interiorCollectionView.rightAnchor.constraint(equalTo: view.rightAnchor, constant: 0).isActive = true
        interiorCollectionView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 0).isActive = true
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print(interiorCensorArray.count)
    ...
    func createNavBar(item : UINavigationItem){
        ...
        appearance.backgroundImage = UIImage(named: "interiorHeader")
